...
output:
  rmarkdown::html_vignette:
    ...
    dev: png
vignette: >
  %\VignetteIndexEntry{HRRI: End-to-End Workflow}
...
(2026). Ghotbi, M., Ghotbi, M., Stukenbrock, E. H. (2026). *HRRI: a direction-aware R framework for quantifying 
soil–plant–microbiome redox resilience across hydroclimatic disturbance events* Manuscript submitted. Manuscript submitted.
