#' @title Worked example: a complete HRRI workflow
#'
#' @name HRRI_workflow_example
#' @aliases redoxrri_example
#'
#' @description
#' A documentation page, not a dataset: there is no object named
#' \code{HRRI_workflow_example} to load, and \code{data()} will not find
