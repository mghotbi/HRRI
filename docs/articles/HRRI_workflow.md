...
#> [17] htmlwidgets_1.6.4  tibble_3.3.1       desc_1.4.3         bslib_0.11.0      
...
#> [41] ragg_1.5.2         rmarkdown_2.31     tools_4.5.1        pkgconfig_2.0.3   
#> [45] htmltools_0.5.9
```

## Reference

Ghotbi, M., Ghotbi, M., Stukenbrock, E. H. (2026). Ghotbi, M., Ghotbi,
M., Stukenbrock, E. H. (2026). *HRRI: a direction-aware R framework for
quantifying soil–plant–microbiome redox resilience across hydroclimatic
disturbance events* Manuscript submitted. Manuscript submitted.
